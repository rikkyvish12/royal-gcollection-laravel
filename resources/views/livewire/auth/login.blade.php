            ...
            @if(!$showOtpInput)
                <div class="space-y-4">
                    ...
                    <button wire:click="sendOtp" 
                            class="w-full py-5 bg-royal-dark text-white text-[10px] font-bold tracking-[0.4em] uppercase hover:bg-royal-gold hover:text-royal-dark transition-all duration-500 shadow-xl">
