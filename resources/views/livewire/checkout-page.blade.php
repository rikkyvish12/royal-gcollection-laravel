<div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    <div class="bg-white p-8 rounded-lg shadow-lg h-fit">
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <p class="text-gray-600 text-sm font-bold mb-3 text-center">OR</p>
            <a href="{{ $whatsappOrderUrl }}" target="_blank" 
               class="w-full bg-green-500 text-white py-3 rounded-lg font-bold hover:bg-green-600 transition flex items-center justify-center space-x-2">
