...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-stone-50 font-sans text-royal-dark antialiased" x-data="{ showSearchModal: false, searchQuery: '' }">
        ...
        <a href="https://wa.me/918286608983?text=Hello%20Royal%20Collection!%20I%20would%20like%20to%20know%20more%20about%20your%20products." 
           target="_blank"
           class="fixed bottom-24 md:bottom-8 right-4 md:right-8 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl z-50 transition-all duration-300 hover:scale-110 flex items-center justify-center group">
            ...
            <span class="absolute right-full mr-3 bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
